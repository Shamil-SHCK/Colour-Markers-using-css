{
  ...
  "metadata": {
    "colab": {
      ...
      "authorship_tag": "ABX9TyNFIIoY96KaDcR6CSL2YwUi",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/Shamil-SHCK/Colour-Markers-using-css/blob/master/graph_theory.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "7sCaJPVo-GM-",
        "outputId": "93cb704a-3176-4667-c57e-dc5400be220e"
      },
      "execution_count": null,
      "outputs": [
        {
          ...
          "text": [
            ...
            "Enter subdivision parameter k (≥1): 3\n",
            "\n",
            "+---------+--------------+--------+---------+---------+----------+----------+-----------+\n",
            "| Graph   | Type         |   χ(G) |   χ(SG) |   χ'(G) |   χ'(SG) |   χ''(G) |   χ''(SG) |\n",
            "+=========+==============+========+=========+=========+==========+==========+===========+\n",
            "| K3      | 3-subdivided |      3 |       2 |       3 |        2 |        3 |         3 |\n",
            "+---------+--------------+--------+---------+---------+----------+----------+-----------+\n",
            "| K4      | 3-subdivided |      4 |       2 |       3 |        2 |        5 |         3 |\n",
            "+---------+--------------+--------+---------+---------+----------+----------+-----------+\n",
            "| K5      | 3-subdivided |      5 |       2 |       5 |        2 |        5 |         3 |\n",
            "+---------+--------------+--------+---------+---------+----------+----------+-----------+\n",
            "| K6      | 3-subdivided |      6 |       2 |       5 |        2 |        7 |         3 |\n",
            "+---------+--------------+--------+---------+---------+----------+----------+-----------+\n",
            "| K7      | 3-subdivided |      7 |       2 |       7 |        2 |        7 |         3 |\n",
            "+---------+--------------+--------+---------+---------+----------+----------+-----------+\n",
